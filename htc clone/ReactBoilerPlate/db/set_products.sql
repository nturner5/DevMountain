DROP TABLE IF EXISTS smartphones, accessories, item, deviceAccessory
...
INSERT INTO smartphones (name, image, price, description, itemtypeid) VALUES 
('HTC U Ultra', '../../../assets/images/products/smartphones/htc-u-ultra-blue-global-phone-listing-255.png', 749.00, 'Perfectly symmetric. Exquisitely thin. HTC Sense Companion with Voice Recognition. HTC', 1),
('HTC 10', '../../../assets/images/products/smartphones/htc-10-global-carbon-gray-phone-listing-255.png', 699.00, 'Its more of what you’re looking for in a flagship phone. Unparalleled performance.', 1),
('HTC Bolt', '../../../assets/images/products/smartphones/htc-bolt-grey-us-phone-listing-225.png', 600.00, 'Meet HTC Bolt. The metal unibody phone that combines sophisticated style with sound tuned', 1),
('HTC One A9', '../../../assets/images/products/smartphones/htc-aero-global-carbon-gray-phone-listing-255.png', 429.00, 'Perfectly symmetric. Exquisitely thin. HTC Sense Companion with Voice Recognition. HTC', 1),
('HTC One M9', '../../../assets/images/products/smartphones/htc-u-ultra-blue-global-phone-listing-255.png', 499.00, '20 MP camera with sapphire camera cover lens to deliver crisp, clear photos. Front-facing', 1);
...
('USB-C Digital to 3.5mm adaptor', '../../../assets/images/products/usb-c-digital-to-3-5mm-with-logo(1).png', 11.99, 'Use your 3.5mm headphones with the USB-C Digital to 3.5mm adaptor', 1),
